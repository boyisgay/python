...
for tr in trs:
    ...
    category = tr.xpath("//tr[position()>1]//td[2]/text()")[0]
    nums = tr.xpath("//tr[position()>1]//td[3]/text()")[0]
    address = tr.xpath("//tr[position()>1]//td[4]/text()")[0]
    pubtime = tr.xpath("//tr[position()>1]//td[5]/text()")[0]
